          ...
          <div className="lg:col-span-8">
            <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 items-start">
                <div className="sm:col-span-5 aspect-4/3 rounded-xl overflow-hidden shadow-xs border border-slate-200">
                  <img 
        ...
        <div className="bg-slate-900 text-white rounded-3xl p-8 sm:p-12 border border-slate-800 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {processStages.map((st, idx) => (
              <div key={idx} className="bg-slate-800/80 p-5 rounded-2xl border border-slate-700 space-y-3">
                <div className="w-8 h-8 rounded-lg bg-[#085AB3] text-white flex items-center justify-center text-xs font-extrabold">
                  {st.step}
                </div>
